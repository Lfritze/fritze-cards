...
const router = _express.default.Router(); // for user profile 
...
router.get("/", _util.isAuth, async (req, res) => {
  const orders = await _orderModel.default.find({}).populate('user'); // to have access to the user info
